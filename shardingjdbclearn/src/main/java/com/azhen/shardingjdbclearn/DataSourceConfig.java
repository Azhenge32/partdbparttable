package com.azhen.shardingjdbclearn;


import com.azhen.shardingjdbclearn.strategy.ModuloDatabaseShardingAlgorithm;
import com.azhen.shardingjdbclearn.strategy.ModuloTableShardingAlgorithm;
 ...
 */
@Configuration
@MapperScan(basePackages = "com.azhen.shardingjdbclearn.mapper", sqlSessionTemplateRef  = "test1SqlSessionTemplate")
public class DataSourceConfig {
    ...
    public SqlSessionFactory testSqlSessionFactory(@Qualifier("dataSource") DataSource dataSource) throws Exception {
        ...
        bean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath:com/azhen/shardingjdbclearn/mapper/*.xml"));
